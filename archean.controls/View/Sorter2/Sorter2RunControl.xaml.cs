...
{
    public partial class Sorter2RunControl
    {
        public Sorter2RunControl()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty SorterDisplayVmProperty =
            DependencyProperty.Register("SorterDisplayVm", typeof(SorterDisplayVm), typeof(Sorter2RunControl),
        ...
        {
            var sorterControlControl = (Sorter2RunControl)d;
        ...
        private void DoStop()
        {
            SorterDisplayVm = SorterDisplayVm.ChangeAnimationSpeed(AnimationSpeed.None);
        }
        ...
        public static readonly DependencyProperty AnimationSpeedProperty =
            DependencyProperty.Register("AnimationSpeed", typeof(AnimationSpeed), typeof(Sorter2RunControl),
        ...
        public static readonly DependencyProperty StageLayoutProperty =
            DependencyProperty.Register("StageLayout", typeof(StageLayout), typeof(Sorter2RunControl),
